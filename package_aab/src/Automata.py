...
class Automata:
    ...
    The search is started at the first state of the "machine" and at the first character of the text,
    ...
    def printAutomata(self):
        ...
        # iterates over the keys of the transition table, which are tuples containing the current state and input character.
        for keys in self.transitionTable.keys():
            # prints the current state, input character and the next state, using the keys to access the values in the transition table.
